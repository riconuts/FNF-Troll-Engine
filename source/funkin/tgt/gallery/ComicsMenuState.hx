...
class ComicsMenuState extends MusicBeatState
{
	...
	{	
		...
		for (mod in funkin.ChapterData.reloadChapterFiles())
		{
...
class ComicReader extends MusicBeatState
{
	...
	var loadingShader = new funkin.objects.shaders.LoadShader();
