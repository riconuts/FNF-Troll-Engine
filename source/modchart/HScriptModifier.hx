...
{
        public static var scripts:Array<FunkinHScript> = [];
        ...
        public static function fromName(modMgr:ModManager, ?parent:Modifier, scriptName:String):Null<HScriptModifier>
        {
                ...
                for (file in [#if MODS_ALLOWED Paths.modFolders(fileName), #end Paths.getPreloadPath(fileName)])
                {
                        ...
                        script.set("this", modifier);
			script.set("getValue", modifier.getValue);
			script.set("getPercent", modifier.getPercent);
			script.set("getSubmodValue", modifier.getSubmodValue);
			script.set("getSubmodPercent", modifier.getSubmodPercent);
			script.set("setValue", modifier.setValue);
			script.set("setPercent", modifier.setPercent);
			script.set("setSubmodValue", modifier.setSubmodValue);
			script.set("setSubmodPercent", modifier.setSubmodPercent);
                        return modifier;
                }
