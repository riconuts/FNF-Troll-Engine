...
import options.OptionsSubstate.Widget;
	...
	*/
	...
	override function update(elapsed:Float)
	{
		...
		if (FlxG.keys.pressed.BACKSPACE){
			...
			saveJSON((FlxG.keys.pressed.SHIFT) ? charToFunkinData(curChar) : charToPsychData(curChar));
		}else
			updateKeys();
	...
	public static function charToFunkinData(char){
		return {
