...
class MainMenuState extends MusicBeatState {
	...
	public static var betaVersion(get, default):String = 'beta.2'; // beta version, make blank if not on a beta version, otherwise do it based on semantic versioning (alpha.1, beta.1, rc.1, etc)
