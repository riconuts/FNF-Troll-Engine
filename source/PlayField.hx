...
class PlayField extends FlxTypedGroup<StrumNote> {
	...
	public function new(x:Float, y:Float, keyCount:Int = 4, ?who:Character, isPlayer:Bool = false, cpu:Bool = false, ?playerControls:Bool)
    {
        super();
	...
	public function generateReceptors(?x:Float)
    {
		...
		{
			var babyArrow:StrumNote = new StrumNote(baseX, baseY, data, this);
